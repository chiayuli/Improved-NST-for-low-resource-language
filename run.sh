...
if [ ${lang} == "hu" ]; then
  ...
  train_config=conf/tuning/train_rnn_small_bs10.yaml
  lm_train_set=train_${lang}_init_and_fake_${volume}
  #lm_train_set=train_${lang}_init_and_fake_300KWEB
fi
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    for rtask in "${unlabel_set}" "${recog_set}" ; do #${unlabel_set}; do
    (
        recog_opts=
...
[ "$ver" == "62" ] && model_module="espnet.nets.pytorch_backend.unsupervised51:E2E"
[ "$ver" == "63" ] && model_module="espnet.nets.pytorch_backend.unsupervised52:E2E"
[ "$ver" == "64" ] && model_module="espnet.nets.pytorch_backend.unsupervised53:E2E"
[ "$ver" == "65" ] && model_module="espnet.nets.pytorch_backend.unsupervised54:E2E"
